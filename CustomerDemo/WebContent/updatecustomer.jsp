...
<body>
 ...
 <hr>
	...
	<div class="box1">
		...
		<form class="login-form1" action="update" method="post">
	...
	<% 
		...
		%>
				...
				Card number 	<input type="text" name="cardnumber" value="<%=cardnumber%>"><br>
				Expire Date 	<input type="date" name="expiredate" value="<%=expiredate%>"><br>
				Security Code 	<input type="text" name="securitycode" value="<%=securitycode%>"><br>
