...
<h1 style="font-family:verdana; font-size:50; color:#16a085;"> Delete Room Information</h1><br /><br />
...
<form action ="rDelete" method="post">
		...
		<h3 style="font-family:verdana; color:#2ecc71; " >Room ID  </h3> <input type="text" name="rid" value="<%= rid %>" readonly><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Hotel ID  </h3> <input type="text" name="hid" value="<%= hid %>"readonly><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Room Price   </h3><input type="text" name="price" value="<%= price %>"readonly><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Number of Rooms   </h3><input type="text" name="tno" value="<%= tno %>"readonly><br>
	 	<h3 style="font-family:verdana; color:#2ecc71; " >Booked Rooms </h3> <input type="text" name="bno" value="<%= bno %>"readonly><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Hotel Name  </h3><input type="text" name="hname" value="<%= hname %>"readonly><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Room Type </h3> <input type="text" name="type" value="<%= type %>" readonly><br>
		
		
		
		<input type="submit" name="submit" value="Delete Rooms">
	</form>
</center>
