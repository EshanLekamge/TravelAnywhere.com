...
<link rel="stylesheet" type ="text/css" href="style/kzunCss.css" />itle>
</head>
<body>
 <hr>
...
<h1 style="font-family:verdana; font-size:50; color:#16a085;">Update Hotel Information</h1><br /><br />
	...
	<form action ="hUpdate" method="post">
		...
		<h3 style="font-family:verdana; color:#2ecc71; " >Hotel Name  </h3> <input type="text" name="name" value="<%= name %>"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Email   </h3><input type="text" name="email" value="<%= email %>"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Contact Number   </h3><input type="text" name="phone" value="<%= phone %>"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >No Of Luxury Rooms </h3> <input type="text" name="lrooms" value="<%= lno %>"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >No Of Economy Rooms</h3> <input type="text" name="erooms" value="<%= eno %>"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Location   </h3> <input type="text" name="location" value="<%= location %>"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Image   </h3> <input type="text" name="img" value="<%= img %>"><br>
