...
.hotelimg
{
	...
	<center>
	<table>
	<c:forEach var="hotel" items = "${hotelInfo}">
	</br>
	<tr>
	<td>${hotel.hotelID}</td>
	</tr>
	<tr>
	<td>${hotel.hotelName}</tr>
	</tr>
	<tr>
	<td>${hotel.email}</td>
	</tr>
	...
	<tr>
	<td><img class = "hotelimg" src = "${hotel.IMG}"/></td></br></br></br>
	<tr><td>
	<form action="LuxRoomDet" method="POST">
	<input type="hidden" name="roomButton" value = "${hotel.hotelID}" >
	<button type = "submit" name = "showRooms" value="Show Rooms">Show Luxury Rooms</button>
	</form>
	</td></tr>
	<tr><td>
	<form action="EcoRoomDet" method="POST">
	<input type="hidden" name="roomButton2" value = "${hotel.hotelID}" >
	<button type = "submit" name = "showRooms2" value="Show Rooms2">Show Economy Rooms</button>
	</form>
	</td></tr>
	</c:forEach>
	</table>
