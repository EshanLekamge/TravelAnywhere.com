...
<h1 style="font-family:verdana; font-size:50; color:#16a085;"> Administrator LogIn</h1><br /><br />

	<form action="adminLog" method="post">
		<h2 style="font-family:verdana; color:#2ecc71; " >User ID  </h2> <input type="text" name="uid"> <br>
		<h2 style="font-family:verdana; color:#2ecc71; " >Password  </h2> <input type="password" name="password"><br>
