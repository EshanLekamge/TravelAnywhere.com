...
.roomimg
{
	...
	<c:forEach var="ecorooms" items = "${EconomyRoomlInfo}">
	</br>
	<img class = "roomimg" src = "${ecorooms.IMG}"/></br>
	<table>
	<tr>
	<td>Room ID</td><td>${ecorooms.economyRoomID}</td>
	</tr>
	<tr>
	<td>Room Price</td><td>${ecorooms.economyRoomPrice}</td>
	</tr>
	<tr>
	<td>No of Rooms</td><td>${ecorooms.noOfEcoRooms}</td>
	</tr>
	<tr>
	<td>Booked Rooms</td><td>${ecorooms.bookedERooms}</td>
	</tr>
	<tr>
	<td>Available Rooms</td><td>${ecorooms.noOfEcoRooms-ecorooms.bookedERooms}</td>
	</tr>
	<tr>
	<td>Hotel Name</td><td>${ecorooms.hotelName}</td>
	</tr>
	<tr>
	<td>Room Type</td><td>${ecorooms.roomType}</td>
	</tr>
	</table>
	</center>
	...
	<center>
	<table>
	<form action = "EcoBooking" method = "post">
	<tr>
	...
	<input type="hidden" name="hotelname" value = "${ecorooms.hotelName}" >
	<input type="hidden" name="roomtype" value = "${ecorooms.roomType}" >
	<input type="hidden" name="roomid" value = "${ecorooms.economyRoomID}" >
	<input type="hidden" name="hotelid" value = "${ecorooms.hotelID}" >
	<input type = "submit" name = "reserveeco" value="Reserve">
