...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="csslogin/deleteguest.css">
<!--===============================================================================================-->
...
<div class="container">
	<form action="delete" method="post" >
		...
		<input type="submit" name="submit" class="btn btn-danger" data-toggle="modal" value="Delete Account"><br>
	</div>
