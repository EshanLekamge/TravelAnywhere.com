      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
            ...
            <form action="contactInsert" method="post" class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row">
                <div class="col-md-6 form-group">
                  <label for="name">Name</label>
                  <input type="text" id="name" name="nam" class="form-control ">
                </div>
                <div class="col-md-6 form-group">
                  <label for="phone">Phone</label>
                  <input type="text" id="phone" name="pho" class="form-control ">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <textarea name="message" id="message" name ="messege" class="form-control " cols="30" rows="8"></textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 form-group">
          ...
          <div class="col-md-5" data-aos="fade-up" data-aos-delay="200">
            <div class="row">
              <div class="col-md-10 ml-auto contact-info">
                <p><span class="d-block">Address:</span> <span> Sri Lanka Dahanayake Mw,<br>100 Independence Square,<br>Colombo 007</span></p>
                <p><span class="d-block">Phone:</span> <span> +94115069829</span></p>
                <p><span class="d-block">Email:</span> <span> info@anytimetravel.com</span></p>
              </div>
            </div>
          </div>
        </div>
