...
<h1 style="font-family:verdana; font-size:50; color:#16a085;">Insert information</h1><br /><br />


<input id="inp" type="button" value="Hotel Form" onclick="location.href='HotelForm.jsp';" />
<input id="inp" type="button" value="Rooms Form" onclick="location.href='RoomsForm.jsp';" />
</center>
