...
<h1 style="font-family:verdana; font-size:50; color:#16a085;"> Insert New Hotel Information</h1><br /><br />

	<form action ="hInsert" method="post">
	
		<h3 style="font-family:verdana; color:#2ecc71; " >Hotel Name   </h3><input type="text" name="name"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Email   </h3><input type="text" name="email"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Contact Number   </h3> <input type="text" name="phone"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >No Of Luxary Rooms  </h3> <input type="text" name="lrooms"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >No Of Economy Rooms  </h3><input type="text" name="erooms"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Location   </h3> <input type="text" name="location"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Image   </h3>  <input type="text" name="img"><br>
		
		<input type="submit" name="submit" value="Add new hotel">
	</form>
</center>
