...
input[type=submit] 
{
  ...
  border-radius: 25px;
    ...
    <center>
	<form action = "bookingDet" method = "post">
		
		<input type = "text" name = "cusid" placeholder = "Enter Customer id">
		<input type = "submit" name = "idbutton" value = "View Your Bookings">
	</form>
	</center>
	...
	<div class = "informations">
        <table alt="destinations" width = "1000px" height = "200px">
			<tr>
			<center>
                <td><h3><a href = "aboutus.jsp">About us</h3></td>
                <td><h3><a href = "contact.jsp">Contact us</h3></td>
