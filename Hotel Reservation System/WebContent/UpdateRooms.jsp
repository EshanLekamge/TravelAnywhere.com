...
<h1 style="font-family:verdana; font-size:50; color:#16a085;"> Update Room Information</h1><br /><br />


<form action ="rmUpdate" method="post">
		...
		<h3 style="font-family:verdana; color:#2ecc71; " >Room Price </h3> <input type="text" name="price" value="<%= price %>"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Number of Rooms   </h3><input type="text" name="tno" value="<%= tno %>"><br>
	 	<h3 style="font-family:verdana; color:#2ecc71; " >Booked Rooms </h3> <input type="text" name="bno" value="<%= bno %>"><br>
		<h3 style="font-family:verdana; color:#2ecc71; " >Hotel Name </h3> <input type="text" name="hname" value="<%= hname %>"><br>
